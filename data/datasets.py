...
class OASISBrainValDataset(Dataset):
    def __init__(self, data_path, transforms):
        ...
        self.number = 90
        self.transforms = transforms
        data_list = '/home/user/cy/TransMorph/OASIS/OASIS_L2R_2021_task03/val_pairs.txt'
        m_names = []
        f_names = []
...
class OASISBrainTestDataset(Dataset):
    def __init__(self, data_path, transforms):
        ...
        self.number = 90
        self.transforms = transforms
        data_list = '/home/user/cy/TransMorph/OASIS/OASIS_L2R_2021_task03/test_pairs.txt'
        m_names = []
        f_names = []
        with open(os.path.join(self.img_paths, data_list), 'r') as f:
            for line in f.readlines():
