...
def main():
    batch_size = 1
    train_dir = '/home/user/cy/TransMorph/OASIS/OASIS_L2R_2021_task03/All/'
    data_dir = '/home/user/cy/TransMorph/OASIS/OASIS_L2R_2021_task03/'
    weights = [1, 1] # loss weights
    save_dir = 'Morph_ncc_{}_diffusion_{}/'.format(weights[0], weights[1])
